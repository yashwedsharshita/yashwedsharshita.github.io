...
const sectionsData = [
  ...
  },
  {
    ...
    bodyText: [``,`<i class="mb-24">Invite you to celebrate the auspicious union of our beloved son</i>`, "<h3><i>Yash Raj🤵","with", "Harshita Srivastava👰</i></h3>", `<i class="mt-24">(D/o Mrs. Neelam Srivastava and Late Mr. Sanjay Srivastava)</i>`, `<i class="mt-12">We look forward to your presence and blessings on this joyous occasion...</i>`],
    type: "story",
