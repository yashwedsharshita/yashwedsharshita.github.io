...
const sectionsData = [
  ...
  {
    head: "<h4>Mrs. Vandana Saxena and Mr. Ashutosh Saxena</h4>",
    bodyText: [`<i class="mb-24">Invite you to celebrate the auspicious union of our beloved son</i>`, "<h3>Yash Raj🤵", "<i>with</i>", "Harshita Srivastava👰</h3>", `<i class="mt-24">(D/o Mrs. Neelam Srivastava and Late Mr. Sanjay Srivastava)</i>`, `<i class="mt-12">We look forward to your presence and blessings on this joyous occasion...</i>`],
    type: "story",
